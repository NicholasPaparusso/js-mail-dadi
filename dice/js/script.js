...
function go(){
 ...
 let UserNumber = Math.ceil(Math.random()* diceNumber. length)
  ...
  if(UserNumber === 1 && document.getElementById('dice-user-1').classList.contains('hide') ){
    ...
    }else if (UserNumber !== 1 && !(document.getElementById('dice-user-1').classList.contains('hide'))){
  ...
  if(UserNumber === 2 && document.getElementById('dice-user-2').classList.contains('hide') ){
    ...
    }else if (UserNumber !== 2 && !(document.getElementById('dice-user-2').classList.contains('hide'))){
    ...
    }else if (UserNumber !== 3 && !(document.getElementById('dice-user-3').classList.contains('hide'))){
    ...
    }else if (UserNumber !== 4 && !(document.getElementById('dice-user-4').classList.contains('hide'))){
    ...
    }else if (UserNumber !== 5 && !(document.getElementById('dice-user-5').classList.contains('hide'))){
    ...
    }else if (UserNumber !== 6 && !(document.getElementById('dice-user-6').classList.contains('hide'))){
    ...
    }else if (CpuNumber !== 1 && !(document.getElementById('dice-cpu-1').classList.contains('hide'))){
  ...
  if(CpuNumber === 2 && document.getElementById('dice-cpu-2').classList.contains('hide') ){
    ...
    }else if (CpuNumber !== 2 && !(document.getElementById('dice-cpu-2').classList.contains('hide'))){
    ...
    }else if (CpuNumber !== 3 && !(document.getElementById('dice-cpu-3').classList.contains('hide'))){
    ...
    }else if (CpuNumber !== 4 && !(document.getElementById('dice-cpu-4').classList.contains('hide'))){
    ...
    }else if (CpuNumber !== 5 && !(document.getElementById('dice-cpu-5').classList.contains('hide'))){
    ...
    }else if (CpuNumber !== 6 && !(document.getElementById('dice-cpu-6').classList.contains('hide'))){
